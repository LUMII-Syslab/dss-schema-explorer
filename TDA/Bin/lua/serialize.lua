...
selector_generator = {
  graphDiagramType = selector_mem_fn(function(object)
    return "GraphDiagramType[id=" .. lQuery(object):log("id"):attr("id") .. "]"
  end)
  
  ,graphDiagramStyle = selector_mem_fn(function(object)
    local graphDiagramStyle = lQuery(object)
    return selector_generator.graphDiagramType(graphDiagramStyle:find("/graphDiagram:last/graphDiagramType")) ..
