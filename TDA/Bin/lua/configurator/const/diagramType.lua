...
function add_diagramType_diagram(id, caption)	
	...
	local collection_popUpDiagram = lQuery.create("PopUpDiagramType", {cType = diagram_type})
		cu.add_PopUpElementType(collection_popUpDiagram, "Cut", "interpreter.CutCopyPaste.Cut", 1)
		cu.add_PopUpElementType(collection_popUpDiagram, "Copy", "interpreter.CutCopyPaste.Copy", 2)
		cu.add_PopUpElementType(collection_popUpDiagram, "Delete", "interpreter.Delete.Delete", 3)
		...
		cu.add_PopUpElementType(collection_popUpDiagram, "Reroute Line", "utilities.Reroute", 6)

	cu.default_key_shortcuts(diagram_type, "cType")
	cu.add_key_shortcut(diagram_type, "eType", "Ctrl V", "interpreter.CutCopyPaste.Paste")
	cu.add_key_shortcut(diagram_type, "eType", "Ctrl T", "configurator.configurator.add_diagram_toolbar")
	cu.add_key_shortcut(diagram_type, "eType", "Ctrl P", "configurator.configurator.add_diagram_popUp")
	cu.add_key_shortcut(diagram_type, "eType", "Ctrl K", "configurator.configurator.add_diagram_key_shortcuts")
	cu.add_key_shortcut(diagram_type, "eType", "Ctrl D", "configurator.configurator.diagram_style")
	cu.add_key_shortcut(diagram_type, "eType", "Ctrl G", "configurator.configurator.generate_instances")
	cu.add_key_shortcut(diagram_type, "eType", "E", "configurator.configurator.generate_script_dialog")
	
	local toolbar_type = lQuery.create("ToolbarType", {graphDiagramType = diagram_type})
		--cu.add_toolbar_element_type(toolbar_type, "Add ToolBar", "configurator.configurator.add_diagram_toolbar", 1, "Toolbar.BMP")
		cu.add_toolbar_element_type(toolbar_type, "Versioning", "configurator.configurator.versioning", 1, "versioning.BMP")
		--cu.add_toolbar_element_type(toolbar_type, "Automatic Migration", "configurator.configurator.automatic_migration", 2, "tree.bmp")
		--cu.add_toolbar_element_type(toolbar_type, "Manual Migration", "configurator.configurator.generate_script_dialog", 3, "tree.bmp")

		cu.add_toolbar_element_type(toolbar_type, "Visualize MM", "configurator.configurator.make_repozitory_class_diagram", 4, "VisualizeMM.BMP")
		cu.add_toolbar_element_type(toolbar_type, "Project Translets", "configurator.configurator.edit_project_object", 5, "ProjectTranslets.bmp")
		cu.add_toolbar_element_type(toolbar_type, "Graph Diagram Engine", "configurator.configurator.edit_head_engine", 6, "graphDiagramEngine.bmp")
		cu.add_toolbar_element_type(toolbar_type, "Tree Engine", "configurator.configurator.edit_tree_engine", 7, "tree.bmp")	
