...
function delete_configurator_types()
	print("delete configurator type")
	...
	tool_type:find("/graphDiagramType"):each(function(graph_diagram_type)
		if graph_diagram_type:attr("id") == "specificationDgr" or 
			graph_diagram_type:attr("id") == "MMInstances" or 
			graph_diagram_type:attr("id") == "Repository" or graph_diagram_type:attr("id") == "Instances" then
...
function delete_configurator_diagrams(dgr_to_be_deleted)
	...
	print("delete configurator diagrams")
	print(dumptable(dgr_to_be_deleted))

	delete.delete_diagrams_from_table(dgr_to_be_deleted, {toolbar = true})
end
